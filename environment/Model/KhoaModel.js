...
const queueUrl = "https://sqs.us-east-1.amazonaws.com/588509624082/test";
...
async function Update(ID,Khoa){
    ...
    let sqsKhoaData = {
        ...
        MessageBody: JSON.stringify(KhoaData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/588509624082/UpdateKhoa'
    };
    let sendSqsMessage = sqs.sendMessage(sqsKhoaData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
...
async function Delete(ID){
    ...
    let sqsKhoaData = {
        ...
        MessageBody: JSON.stringify(KhoaData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/588509624082/DeleteKhoa'
    };
    let sendSqsMessage = sqs.sendMessage(sqsKhoaData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
