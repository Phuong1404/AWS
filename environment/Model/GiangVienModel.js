...
async function Create(Data)
{
    ...
    let sqsLopData = {
        ...
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/588509624082/InsertGV'
    };
...
async function Update(ID,Data){
    ...
    let sqsLopData = {
        ...
        MessageBody: JSON.stringify(GVData),
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/588509624082/UpdateGV'
    };
    let sendSqsMessage = sqs.sendMessage(sqsLopData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
...
async function Delete(ID){
    ...
    let sqsLopData = {
        ...
        QueueUrl: 'https://sqs.us-east-1.amazonaws.com/588509624082/DeleteGV'
    };
    let sendSqsMessage = sqs.sendMessage(sqsLopData).promise();
    sendSqsMessage.then((data) => {
        console.log(`OrdersSvc | SUCCESS: ${data.MessageId}`);
